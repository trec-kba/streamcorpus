...
object ContentItem extends ThriftStructCodec[ContentItem] {
  ...
  def unapply(_item: ContentItem): Option[Product11[Option[ByteBuffer], Option[String], Option[String], Option[String], Option[String], Seq[String], Map[String, Tagging], Map[String, Seq[Label]], Map[String, Seq[Sentence]], Map[String, ByteBuffer], Option[Language]]] = Some(_item)
...
trait ContentItem extends ThriftStruct
  with Product11[Option[ByteBuffer], Option[String], Option[String], Option[String], Option[String], Seq[String], Map[String, Tagging], Map[String, Seq[Label]], Map[String, Seq[Sentence]], Map[String, ByteBuffer], Option[Language]]
