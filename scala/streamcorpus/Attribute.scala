 ...
 * the text.
 */
object Attribute extends ThriftStructCodec[Attribute] {
  val Struct = new TStruct("Attribute")
  val AttributeTypeField = new TField("attributeType", TType.I32, 1)
  val EvidenceField = new TField("evidence", TType.STRING, 2)
  val ValueField = new TField("value", TType.STRING, 3)
  val SentenceIdField = new TField("sentenceId", TType.I32, 4)
  val MentionIdField = new TField("mentionId", TType.I32, 5)
  ...
  def encode(_item: Attribute, _oproto: TProtocol) { _item.write(_oproto) }
  def decode(_iprot: TProtocol) = Immutable.decode(_iprot)

  def apply(_iprot: TProtocol): Attribute = decode(_iprot)
  ...
  object Immutable extends ThriftStructCodec[Attribute] {
    def encode(_item: Attribute, _oproto: TProtocol) { _item.write(_oproto) }
  ...
  with java.io.Serializable
{
  ...
  override def write(_oprot: TProtocol) {
    ...
    if (attributeType.isDefined) {
      ...
      _oprot.writeFieldBegin(AttributeTypeField)
