...
class ContentItem(object):
  ...
  def __init__(self, raw=None, encoding=None, media_type=None, clean_html=None, clean_visible=None, logs=thrift_spec[6][4], taggings=thrift_spec[7][4], labels=thrift_spec[8][4], sentences=thrift_spec[9][4], sentence_blobs=thrift_spec[10][4], language=None, relations=thrift_spec[12][4], attributes=thrift_spec[13][4], external_ids=thrift_spec[14][4], selectors=thrift_spec[15][4],):
    self.raw = raw
      ...
      if fid == 1:
        ...
        if ftype == TType.MAP:
          ...
          for _i110 in xrange(_size106):
            ...
            iprot.readListEnd()
            self.sentences[_key111] = _val112
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 10:
        if ftype == TType.MAP:
          ...
          for _i123 in xrange(_size119):
            ...
            self.sentence_blobs[_key124] = _val125
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 11:
        ...
        if ftype == TType.MAP:
          ...
          for _i130 in xrange(_size126):
            ...
            iprot.readListEnd()
            self.relations[_key131] = _val132
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 13:
        if ftype == TType.MAP:
          ...
          for _i143 in xrange(_size139):
            ...
            iprot.readListEnd()
            self.attributes[_key144] = _val145
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 14:
        if ftype == TType.MAP:
          ...
          for _i156 in xrange(_size152):
            ...
            iprot.readMapEnd()
            self.external_ids[_key157] = _val158
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 15:
        if ftype == TType.MAP:
          ...
          for _i170 in xrange(_size166):
            ...
            iprot.readListEnd()
            self.selectors[_key171] = _val172
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.taggings is not None:
      ...
      for kiter180,viter181 in self.taggings.items():
    ...
    if self.labels is not None:
      ...
      oprot.writeMapBegin(TType.STRING, TType.LIST, len(self.labels))
      for kiter182,viter183 in self.labels.items():
        oprot.writeString(kiter182)
        oprot.writeListBegin(TType.STRUCT, len(viter183))
        for iter184 in viter183:
          iter184.write(oprot)
        oprot.writeListEnd()
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
    if self.sentences is not None:
      ...
      for kiter185,viter186 in self.sentences.items():
        oprot.writeString(kiter185)
        oprot.writeListBegin(TType.STRUCT, len(viter186))
    ...
    if self.sentence_blobs is not None:
      ...
      for kiter188,viter189 in self.sentence_blobs.items():
    ...
    if self.relations is not None:
      ...
      for kiter190,viter191 in self.relations.items():
        oprot.writeString(kiter190)
        oprot.writeListBegin(TType.STRUCT, len(viter191))
    ...
    if self.attributes is not None:
      ...
      for kiter193,viter194 in self.attributes.items():
        ...
        oprot.writeListBegin(TType.STRUCT, len(viter194))
        for iter195 in viter194:
          iter195.write(oprot)
        oprot.writeListEnd()
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
    if self.external_ids is not None:
      ...
      for kiter196,viter197 in self.external_ids.items():
        oprot.writeString(kiter196)
        oprot.writeMapBegin(TType.I32, TType.STRING, len(viter197))
    ...
    if self.selectors is not None:
      ...
      for kiter200,viter201 in self.selectors.items():
...
class StreamItem(object):
      ...
      if fid == 1:
        ...
        if ftype == TType.MAP:
          ...
          for _i221 in xrange(_size217):
            ...
            self.source_metadata[_key222] = _val223
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 9:
        ...
        if ftype == TType.MAP:
          ...
          for _i228 in xrange(_size224):
            ...
            _val230 = ContentItem()
            _val230.read(iprot)
            self.other_content[_key229] = _val230
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 12:
        ...
        if ftype == TType.MAP:
          ...
          for _i248 in xrange(_size244):
            ...
            for _i255 in xrange(_size251):
              ...
              _val250[_key256] = _val257
            iprot.readMapEnd()
            self.external_ids[_key249] = _val250
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.source_metadata is not None:
      ...
      for kiter258,viter259 in self.source_metadata.items():
    ...
    if self.other_content is not None:
      ...
      for kiter260,viter261 in self.other_content.items():
    ...
    if self.ratings is not None:
      ...
      for kiter262,viter263 in self.ratings.items():
        oprot.writeString(kiter262)
        oprot.writeListBegin(TType.STRUCT, len(viter263))
        for iter264 in viter263:
          iter264.write(oprot)
        oprot.writeListEnd()
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
    if self.external_ids is not None:
      oprot.writeFieldBegin('external_ids', TType.MAP, 14)
      oprot.writeMapBegin(TType.STRING, TType.MAP, len(self.external_ids))
      for kiter265,viter266 in self.external_ids.items():
        oprot.writeString(kiter265)
        oprot.writeMapBegin(TType.STRING, TType.STRING, len(viter266))
        for kiter267,viter268 in viter266.items():
